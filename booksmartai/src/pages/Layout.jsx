...
import { Bot, Settings, Code, Calendar, BarChart3, Clock, Building, Shield, MessageSquare, LogOut, User as UserIcon } from "lucide-react"; // Added LogOut, User as UserIcon
import {
  Sidebar,
  SidebarContent,
  SidebarGroup,
  ...
  const checkUserAccess = async () => {
    try {
      ...
      if (currentUser.role === 'admin') {
        ...
        // Dynamically import Business entity
        const { Business } = await import('@/api/entities'); // Assuming this path resolves to your entity definitions
    ...
    <SidebarProvider>
      ...
      <div className="min-h-screen flex w-full">
        <Sidebar className="border-r border-slate-200 bg-white">
          ...
          <SidebarFooter className="border-t border-slate-100 p-4"> {/* Changed padding from p-6 to p-4 */}
            <DropdownMenu>
